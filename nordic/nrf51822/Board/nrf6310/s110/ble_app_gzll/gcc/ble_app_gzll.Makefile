...
C_SOURCE_FILES += ble_app_gzll_device.c
C_SOURCE_FILES += ble_app_gzll_hr.c
C_SOURCE_FILES += ble_app_gzll_ui.c
C_SOURCE_FILES += ble_gzll_app_timer.c
...
# define gzll librarry to be included
